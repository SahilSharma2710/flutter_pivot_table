      ...
      Treemap: function (n, i) {
        ...
        for (
          l = {
            ...
            i = e.extend(!0, {}, l, i),
            h = e("<div>").css({ width: "100%", height: "100%" }),
            s = { name: "All", children: [] },
            r = function (e, t, n) {
              var i, u, l, d, o, a;
              ...
              return (d = { name: a }), r(d, t, n), e.children.push(d);
            },
            c = n.getRowKeys(),
            o = 0,
            a = c.length;
          ...
          (f = c[o]),
            (y = n.getAggregator(f, []).value()),
            null != y && r(s, f, y);
        return (
          (u = t.scale.category10()),
          (g = i.d3.width()),
          (d = i.d3.height()),
          (p = t.layout
            .treemap()
          ...
          t
            ...
            .selectAll(".node")
            .data(
              p.padding([15, 0, 0, 0]).value(function (e) {
                return e.value;
              }).nodes
            )
            .enter()
